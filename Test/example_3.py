...
def battery_map():
    ...
    Max_Temp        = np.array(data['Maximum Discharge Temperature (°C)'])[0] 
    ...
    Feasible_Routes              = Feasible_Routes.loc[Feasible_Routes['Origin ' + month] > Min_Temp] 
    Infeasible_Routes_2          = Feasible_Routes.loc[Feasible_Routes['Origin ' + month] < Min_Temp] 
    Feasible_Routes              = Feasible_Routes.loc[Feasible_Routes['Origin ' + month] < Max_Temp] 
    Infeasible_Routes_3          = Feasible_Routes.loc[Feasible_Routes['Origin ' + month] > Max_Temp] 
    Feasible_Routes              = Feasible_Routes.loc[Feasible_Routes['Destination ' + month] > Min_Temp] 
    Infeasible_Routes_4          = Feasible_Routes.loc[Feasible_Routes['Destination ' + month] < Min_Temp] 
    Feasible_Routes              = Feasible_Routes.loc[Feasible_Routes['Destination ' + month] < Max_Temp] 
    Infeasible_Routes_5          = Feasible_Routes.loc[Feasible_Routes['Destination ' + month] > Max_Temp] 
    Infeasible_Routes_6          = Feasible_Routes.tail(int(len(Feasible_Routes)*(100 - percent_adoption)/100 ))
    Feasible_Routes              = Feasible_Routes.head(int(len(Feasible_Routes)*percent_adoption/100 ))
