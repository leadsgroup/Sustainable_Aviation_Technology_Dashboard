...
def pre_process_route_data():
    ...
    airline_file     = '../Data/Domestic_Flights.xlsx'
    temperature_file = '../Data/Monthly_US_County_Temperature.xlsx'
    ...
    coordinates = np.empty((2 , len(Airline_data)))
    ...
    Airline_data.to_excel( airline + "_Monthly_Temp.xlsx") 
    
    return 
     
if __name__ == '__main__':
    pre_process_route_data()