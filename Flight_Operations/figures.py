...
def generate_flight_ops_passenger_range_plot(Routes_and_Temp,Commercial_Batteries,aircraft,battery_choice,weight_fraction,system_voltage,propulsive_efficiency,percent_adoption,month_no,switch_off):  
    template             = pio.templates["minty"] if switch_off else pio.templates["minty_dark"]     
    font_size            = 16 
...
def generate_flight_ops_airport_electrification(Routes_and_Temp,Commercial_Batteries,aircraft,battery_choice,weight_fraction,system_voltage,propulsive_efficiency,percent_adoption,month_no,switch_off):  
    template             = pio.templates["minty"] if switch_off else pio.templates["minty_dark"]     
    font_size            = 16 
...
def generate_flight_ops_market_analysis(Routes_and_Temp,Commercial_Batteries,aircraft,battery_choice,weight_fraction,system_voltage,propulsive_efficiency,percent_adoption,month_no,switch_off):  
    template             = pio.templates["minty"] if switch_off else pio.templates["minty_dark"]     
    font_size            = 16 
    ...
    fig.update_layout( title_text="Major US. Airline Marker Size: " + str(round(Market/1000000000))+  ' Billion USD.',
                      height        = 400, 
                      width         = 600, 
...
def generate_flight_ops_monthly_emissions(Routes_and_Temp,Commercial_Batteries,aircraft,battery_choice,weight_fraction,system_voltage,propulsive_efficiency,percent_adoption,month_no,switch_off):  
    template             = pio.templates["minty"] if switch_off else pio.templates["minty_dark"]     
    font_size            = 16 
    ...
    for m_i in range(12): 
        ...
        Infeasible_Routes_1  = Routes_and_Temp_Mo[Routes_and_Temp_Mo['Range'] > Range ]  
        Feasible_Routes_1    = Routes_and_Temp_Mo[Routes_and_Temp_Mo['Range'] < Range ] 
        Feasible_Routes_2    = Feasible_Routes_1[Feasible_Routes_1['Origin ' + month[m_i]] > Min_Temp] 
        Infeasible_Routes_2  = Feasible_Routes_1[Feasible_Routes_1['Origin ' + month[m_i]] < Min_Temp] 
        Feasible_Routes_3    = Feasible_Routes_2[Feasible_Routes_2['Origin ' + month[m_i]] < Max_Temp] 
        Infeasible_Routes_3  = Feasible_Routes_2[Feasible_Routes_2['Origin ' + month[m_i]] > Max_Temp]  
        Feasible_Routes_4    = Feasible_Routes_3[Feasible_Routes_3['Destination ' + month[m_i]] > Min_Temp] 
        Infeasible_Routes_4  = Feasible_Routes_3[Feasible_Routes_3['Destination ' + month[m_i]] < Min_Temp] 
        Feasible_Routes_5    = Feasible_Routes_4[Feasible_Routes_4['Destination ' + month[m_i]] < Max_Temp] 
        Infeasible_Routes_5  = Feasible_Routes_4[Feasible_Routes_4['Destination ' + month[m_i]] > Max_Temp] 
        Infeasible_Routes_6  = Feasible_Routes_5.tail(int(len(Feasible_Routes_5)*(100 - percent_adoption)/100 ))
        Feasible_Routes      = Feasible_Routes_5.head(int(len(Feasible_Routes_5)*percent_adoption/100 ))
